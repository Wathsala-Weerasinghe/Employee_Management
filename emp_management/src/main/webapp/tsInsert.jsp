...
<link href="assets/css/tsinsert.css" rel="stylesheet" />
</head>
<body>
<div id="main">
			<nav>
			...
			<style>
    body  {
       background-image: url("assets/img/t5.jpg");
...
<div class="productData" id="tbl" style="color:white">
		...
		<tr><td>Manager ID</td><td>
		 <input type="text" name="mid"><br></td></tr>
		<tr><td>Work Time</td><td>
		 <input type="number" name="wTime"><br></td></tr>
		<tr><td>Work Description</td><td>
		 <input type="text" name="wDes"><br></td></tr>
		<tr>
		<input type="submit" class = "ins"  name="submit" value="Create Time Sheet">
		</tr>
</table>
</div>
	</form>
