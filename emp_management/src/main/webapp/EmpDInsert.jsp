...
<link href="assets/css/empinsert.css" rel="stylesheet" />
</head>
<body>
<div id="main">
			<nav>
...
<div class="productData" id="tbl" style="color:white">
		...
		<tr><td>Phone</td><td>
		 <input type="text" name="phone"><br></td></tr>
		<tr><td>User name </td><td>
		<input type="text" name="uName"><br></td></tr>
		<tr><td>Password </td><td>
		<input type="password" name="pass"><br></td></tr>
		
		<tr>
		<input type="submit"  class = "ins"  name="submit" value="Create Emoplyee Profile">
			</tr>
</table>
</div>
	</form>
