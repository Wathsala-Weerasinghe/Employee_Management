...
<link href="assets/css/upemp.css" rel="stylesheet" />
</head>
<body>
<div id="main">
			<nav>
			...
			<style>
    body  {
       background-image: url("assets/img/t12.jpg");
...
<input type ="text" name="email" value = "<%= email%>"><br></td></tr>
<tr><td>Employee Phone Number</td><td> 
<input type ="text" name="phone" value = "<%= phone%>"><br></td></tr>
<tr><td>Employee User Name</td><td> 
<input type ="text" name="uName" value = "<%= uName%>"><br></td></tr>
<tr><td>Employee Password</td><td> 
<input type ="text" name="pass" value = "<%= pass%>"><br></td></tr>

<tr>
<input type ="submit" class = "upp" name = "submit" value ="Update Employee Profile">
</tr>
</table>
</div>
</form>
