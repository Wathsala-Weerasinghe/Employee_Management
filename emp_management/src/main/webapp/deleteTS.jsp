...
<title>Time Sheet Delete</title>
<link href="assets/css/delts.css" rel="stylesheet" />
</head>
<body>
<div id="main">
			<nav>
...
<input type ="text" name="eid" value = "<%= id%>" readonly><br></td></tr>
...
<tr><td>Employee Manager ID</td><td>
 <input type ="text" name="mid" value = "<%= mid%>" readonly><br></td></tr>
 
<tr><td>Employee Work Time</td><td>
 <input type ="number" name="wTime" value = "<%= wTime%>" readonly><br></td></tr>
 
<tr><td>Employee Work Description</td><td>
 <input type ="text" name="wDes" value = "<%= wDes%>" readonly><br></td></tr>
 
<tr>
<input type ="submit" class = "del" name = "submit" value ="Delete Time Sheet">
</tr>
</table>
</div>
</form>
