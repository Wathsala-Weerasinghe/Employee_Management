...
public class EmployeeDBUtil {
	...
	public static List<Employee> validate(String uname, String password){
		ArrayList<Employee> emp = new ArrayList<>();
				...
				try {
					...
					if(rs.next()) {
						...
						Employee e = new Employee(id, name, email, phone , userN, passW);
						emp.add(e);	
					}
...
boolean isSuccess = false;
	...
	public static List<Employee> getEmDetails(String id) {
		...
		try {
			...
			if(rs.next()) {
				...
				Employee ep = new Employee(id1, name, email, phone , userN, passW);
				em.add(ep);		
			}
